...
@Component({
  ...
  templateUrl: './calendar-date-picker.page.html',
  styleUrls: ['./calendar-date-picker.page.scss'],
})
export class CalendarDatePickerPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.mainObj = this.commonService.datePickerObj;
    this.initDatePicker();
  }
  ...
  closeIonicDatePickerModal() {
    if (this.commonService.needToReload) {
      if (this.commonService.currentSlide != null) {
        this.eventEmitter.publish('updateHomePage', [
          this.commonService.firstDaysOfWeeks[this.commonService.currentSlide]
        ]);
      }
  ...
  closeModal(selectedDate) {
    ...
    this.commonService.needToReload = false;
  ...
  setIonicDatePickerDate() {
    if (this.selctedDateEpoch != 'Invalid date') {
      this.commonService.slideChanged(true);
      this.eventEmitter.publish('updateHomePage', [new Date(this.selctedDateEpoch)]);
    }
    this.closeModal(this.selctedDateEpoch);
  }
